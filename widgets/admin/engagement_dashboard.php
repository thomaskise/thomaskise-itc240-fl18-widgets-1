...
<table border="1" style="border-collapse:collapse" align="center" width="98%" cellpadding="3" cellspacing="3">
	...
	?>
		<tr>
			<td width="250" align="center"><a href="<?=ADMIN_PATH?>engagement_edit.php">Edit Engagements Data</a></td>
			<td>Edit Engagement data such as first, last & email here.</td>
	</tr>
	<tr>
			<td width="250" align="center"><a href="<?=ADMIN_PATH?>engagement_delete.php">Delete Engagements Data</a></td>
